...
//* garip bir kod  - aşağıdaki iç kısım  */
...
if(altEkranText === "0" && num !== "0" && num !== "."){ // iki rakam basıldığı için bu amaçla return yazdık.
  altEkranText = num
    ...
    //* globaldeki bir değişkene önce bir veri atadığımız için, return if'in tamamını (if'in şart kısmı ile yapılması istenilen iç kısmı) return ile yoksaysak bile globaldeki veri kullanılabilir durumda.
  return;
}
 //***************   yukarıdaki iç kısım */
