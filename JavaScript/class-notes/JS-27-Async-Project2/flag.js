    ...
    devletlerDiv.innerHTML += `
        <div class="card text-start w-50 shadow-lg bg-light my-4" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <li class="list-group-item">
                <i class="fas fa-lg fa-comments">${Object.values(a.languages)}</i>
                </li>
                <li class="list-group-item"> <i class="fas fa-lg fa-money-bill-wave">${Object.values(a.currencies)[0].name}</i>  </li>
